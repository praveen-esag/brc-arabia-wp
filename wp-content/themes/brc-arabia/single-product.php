                ...
                <div class="row justify-content-between">
                        ...
                        <div class="breadcrumb">
                            <ul class="breadcrumbList">
                                ...
                                <li class="breadcrumbItem current">
                                    <a href="#" class="text-upper"><?php the_title(); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-12 col-12">
                        <div class="prodBanInfo position-relative">
                            <div class="prodBanImg imgArea position-relative gradOverlayImg">
                                <?php $bannerImg = get_field('_hm_banner_image'); ?>
                                <img src="<?php echo $bannerImg['url']; ?>" alt="<?php echo $bannerImg['alt']; ?>">
                            </div>
                            <div class="titleArea">
                                <h1 class="xlTitle text-white mb-0"><?php the_title(); ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="productInner">
                    <div class="container-theme">
                        ...
                        <?php if (get_field('_avail_sec_title') || get_field('_avail_short_desc') || get_field('_avail_btn_link')) : ?>
                            <section id="<?php echo $avail_value; ?>">
                                <div class="availMesh">
                                    ...
                                    <div class="availContCol <?php echo $contCol; ?>">
                                        <div class="titleArea">
                                            <h3 class="mainTitle mb-3"><?php the_field('_avail_sec_title'); ?></h3>
                                        </div>
                                        <div class="desc">
                                ...
                                <?php if (have_rows('_avail_items')) : ?>
                                    <div class="dualImgArea justify-content-between">
                                        <?php while (have_rows('_avail_items')) : the_row(); ?>
                                            <div class="imgArea">
                                                <div class="titleArea">
                                                    <h3 class="mainTitle mb-4"><?php the_sub_field('_avail_item_title'); ?></h3>
                                                </div>
                                                <?php $_avail_item_img = get_sub_field('_avail_item_img'); ?>
                                                <?php if ($_avail_item_img) : ?>
                                                    <img src="<?php echo esc_url($_avail_item_img['url']); ?>" alt="<?php echo esc_attr($_avail_item_img['alt']); ?>" />
                                                <?php endif; ?>
                                            </div>
                                        <?php endwhile; ?>
                                    </div>
                            ...
                            <section id="faq" class="faqSec">
                                <div class="faqData justify-content-between">
                                    <?php if (get_field('_faq_sec_title') || get_field('_faq_sec_desc')): ?>
                                        <div class="secHead">
                                            <h4 class="mainTitle"><?php the_field('_faq_sec_title'); ?></h4>
                                            <div class="desc">
                                    ...
                                    <div class="faqList">
                                        ...
                                        while (have_rows('_faq_list')) : the_row(); ?>
                                            <div class="faqItem">
                                                <div class="faqHead">
                                                    <h4 class=""><?php the_sub_field('_faq_question'); ?></h4>
                                                </div>
                                            ...
                                            <div class="row justify-content-between">
                                                ...
                                                <?php if ($_dblcol_img) : ?>
                                                    <div class="dualcontImg col-lg-7 col-12">
                                                        <div class="imgArea gradOverlayImg position-relative">
                        ...
                        <section id="projects" class="relProjSec">
                            <div class="container-left">
                                <div class="secHead">
                                    ...
                                    <?php else : ?>
                                        <h3 class="mainTitle">Project with BRC <?php the_title(); ?></h3>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="container-theme">
                                <div class="row justify-content-between">
                                    <div class="col-lg-3 col-12">
                                        <div class="secHead">
                                            <h4 class="mainTitle"><?php echo get_field('_git_sec_title'); ?></h4>
                                            <div class="desc">
                                ...
                                <?php if ($_cert_imgs_images) :  ?>
                                    <div class="row align-items-center certRow">
                                        <div class="col-lg-4 col-12">
                                            <div class="secHead">
                                                <h2 class="mainTitle"><?php the_field('_cert_sec_title'); ?></h2>
                                            </div>
                                        </div>
